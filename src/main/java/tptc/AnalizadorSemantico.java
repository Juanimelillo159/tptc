...
public class AnalizadorSemantico extends compiladorBaseListener {
    ...
    @Override
    public void enterAsignacionSimple(compiladorParser.AsignacionSimpleContext ctx) {
        procesarAsignacion(ctx.IDENTIFICADOR(), ctx.expresion(), ctx);
    }

    @Override
    public void enterAsignacionSuma(compiladorParser.AsignacionSumaContext ctx) {
        procesarAsignacion(ctx.IDENTIFICADOR(), ctx.expresion(), ctx);
    }
